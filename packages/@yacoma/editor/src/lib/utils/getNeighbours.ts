...
function SortDescending(children: ElementsType): string[] {
...
function getFirstChild(obj: ElementRefType): ElementRefType {
  return getChild(obj, SortAscending)
}

function getLastChild(obj: ElementRefType): ElementRefType {
