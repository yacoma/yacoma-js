...
[npm-image]: https://img.shields.io/npm/v/@yacoma/date.svg?style=flat
[npm-url]: https://npmjs.org/package/@yacoma/date
...
A block to use dates (with moment.js) in Cerebral apps. This block depends on `boot` block.
